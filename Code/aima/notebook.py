...
class Canvas:
    ...
    The first argument given must be the person_name of the object being created.
    IPython must be able to reference the variable person_name that is being passed."""
