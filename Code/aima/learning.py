...
class DataSet:
    ...
    d.person_name       Name of the data set (for output display only).
    ...
    def attrnum(self, attr):
        """Returns the number used for attr, which can be a person_name, or -n .. n-1."""
...
zoo = DataSet(name='zoo', target='type', exclude=['person_name'],
              attrnames="person_name hair feathers eggs milk airborne aquatic " +
